...
const Dashboard = () => {
    ...
    return (
        <div>
            ...
            subTitle='Monitor your room listings, track bookings and analyze revenue-all in
            ...
            <div className='flex gap-4 my-8'>
                ...
                {/* total revenue */}
                <div className='bg-primary/3 border border-primary/10 rounded flex p-4 h-22'>
